...
export const renderModal = (component: React.ReactNode, state = initialModalState) => {
  return renderWithProvider(component, state);
};
...
export const renderHeader = (component: React.ReactNode, state = initialHeaderState) => {
  return renderWithProvider(component, state);
};
